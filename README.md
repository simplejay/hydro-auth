...
<pre><code>git clone https://github.com/simplejay/hydro-auth.git
cd hydro-auth
mvn clean package
</code></pre>
<p>jar file is available <a href="https://github.com/simplejay/hydro-auth/blob/master/hydro-auth.jar">here</a></p>
